    ...
    <tr>
      ...
      <td width="500" align="left">
        <div>
          ...
          <p>Hello! I'm a passionate <strong>Java developer</strong> with a solid foundation in object-oriented programming and software development best practices. I previously worked as a <strong>Robotics Instructor</strong> at Colegio del Sagrado Corazón, where I inspired students to explore the fascinating world of technology and robotics.</p>
          ...
          <ul style="text-align: left; margin-left: 20px;">
            <li>🌱 Always learning new technologies and staying up-to-date with industry trends</li>
            <li>🎯 I love creating elegant, efficient, and innovative solutions</li>
            <li>🧠 Particularly interested in backend development and software architecture</li>
            <li>📱 Currently exploring iOS development with <strong>Swift</strong></li>
            <li>⚡ Mastering <strong>Next.js</strong> for modern, reactive web applications</li>
          </ul>
        </div>
      </td>
    </tr>
